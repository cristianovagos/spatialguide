package com.paydayme.spatialguide.core.bluetooth;
...
public class SGBluetoothService {

    private static final String TAG = "SGBluetoothService";
     ...
     */
    public SGBluetoothService(Context context, Handler handler) {
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (SGBluetoothService.this) {
                        switch (mState) {
                            case STATE_LISTEN:
